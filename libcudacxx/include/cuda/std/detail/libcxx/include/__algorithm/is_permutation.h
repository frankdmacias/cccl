...
_LIBCUDACXX_NODISCARD_EXT inline _LIBCUDACXX_HIDE_FROM_ABI
...
_LIBCUDACXX_NODISCARD_EXT inline _LIBCUDACXX_HIDE_FROM_ABI
    _LIBCUDACXX_INLINE_VISIBILITY _LIBCUDACXX_CONSTEXPR_AFTER_CXX11 bool
    __is_permutation(_RandomAccessIterator1 __first1,
  ...
  if (__last1 - __first1 != __last2 - __first2)
    return false;
  return _CUDA_VSTD::is_permutation<_RandomAccessIterator1,
...
_LIBCUDACXX_NODISCARD_EXT inline _LIBCUDACXX_HIDE_FROM_ABI
    ...
    is_permutation(_ForwardIterator1 __first1, _ForwardIterator1 __last1,
                   _ForwardIterator2 __first2, _ForwardIterator2 __last2) {
  return _CUDA_VSTD::__is_permutation(
      __first1, __last1, __first2, __last2, __equal_to{},
      __iterator_category_type<_ForwardIterator1>{},
      __iterator_category_type<_ForwardIterator2>{});
}

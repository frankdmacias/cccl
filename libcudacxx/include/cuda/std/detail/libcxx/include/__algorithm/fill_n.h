...
_OutputIterator __fill_n(_OutputIterator __first, _Size __n, const _Tp& __value_)
{
...
template <class _OutputIterator, class _Size, class _Tp>
inline _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY _LIBCUDACXX_CONSTEXPR_AFTER_CXX11
_OutputIterator fill_n(_OutputIterator __first, _Size __n, const _Tp& __value_)
{

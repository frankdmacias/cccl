...
_LIBCUDACXX_NODISCARD_EXT inline _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY _LIBCUDACXX_CONSTEXPR_AFTER_CXX11
bool __equal(_InputIterator1 __first1, _InputIterator1 __last1,
...
_LIBCUDACXX_NODISCARD_EXT inline _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY _LIBCUDACXX_CONSTEXPR_AFTER_CXX11
bool __equal(_RandomAccessIterator1 __first1, _RandomAccessIterator1 __last1,
...
{
    return _CUDA_VSTD::__equal(__first1, __last1, __first2, __last2, __equal_to{},
        typename iterator_traits<_InputIterator1>::iterator_category(),
        typename iterator_traits<_InputIterator2>::iterator_category());
}
